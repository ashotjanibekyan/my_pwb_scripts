...
__version__ = '$Id: 4e281409e361b4760c78c243b8d5c8bbd093f312 $'
#
import datetime
import locale
import os
...
class DiscussionThread(object):
    ...
    def isthere(self, archiver):
        isthere = archiver.get_attr('isthere')
        if (not isthere) or (isthere and re.search(r'\{\{ՔՓ\|', self.content)):
            return True
        else:
            return False
